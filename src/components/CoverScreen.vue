  ...
  <div class="h-[100dvh] w-full bg-slate-100 flex justify-center overflow-hidden font-sans select-none">
    ...
    <div class="w-full max-w-xl h-full flex flex-col bg-gradient-to-br from-indigo-500 to-purple-600 shadow-2xl relative overflow-hidden">
      ...
      <div class="absolute top-4 left-4 flex items-center gap-3 z-50">
          ...
          <div class="block">
              <h3 class="font-bold text-white text-sm md:text-base leading-tight drop-shadow-md">
                  Jorge Andrade
              </h3>
              <p class="text-xs md:text-sm text-white font-medium tracking-wide drop-shadow-sm">
                  Mentor Digital & IA
              </p>
          </div>
      </div>
      ...
      <div class="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        <p class="text-blue-100 text-lg sm:text-xl font-bold mb-8 tracking-wide text-center animate-fade-in-down delay-100">
          ¡Aprende jugando!
        </p>
      ...
      <div class="p-4 text-center relative z-10 flex flex-col items-center mb-2">
          <div class="flex flex-col items-center gap-1">
              <p class="text-white text-sm sm:text-base font-bold drop-shadow-sm">
                  @Copyright 2026
              </p>
              <p class="text-white text-xs sm:text-sm font-medium drop-shadow-sm opacity-100">
                  v.2.0 Static Edition
              </p>
          </div>
      </div>
